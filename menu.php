 <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              <li class="nav-item">
                <a href="index.php" class="nav-link <?php if($page==1){echo"active";}?>">
			  ...
			  <li class="nav-item">
                <a href="visitas.php" class="nav-link <?php if($page==2){echo"active";}?>">
                  <i class="nav-icon bi bi-journal-medical"></i>
                  <p>Cadastros X Visitas</p>
                </a>
              </li>
			<li class="nav-item">
                <a href="atendimentos.php" class="nav-link <?php if($page==3){echo"active";}?>">
