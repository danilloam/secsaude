...
if (!empty($_SESSION['user']['foto'])) {
    ...
    $fotoPerfil = 'data:image/jpeg;base64,' .
        base64_encode($_SESSION['user']['foto']);

} else {

    $fotoPerfil = 'https://ui-avatars.com/api/?name=' .
        urlencode($_SESSION['user']['nome'] . ' ' . $_SESSION['user']['sobrenome']) .
...
<html lang="en">
  ...
  <head>
    ...
    <link
      ...
      crossorigin="anonymous"
    />
	<?php if (!empty($estiloextra)) echo $estiloextra; ?>
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-footer">
                  <a href="./configuracoes" class="btn btn-outline-secondary">Configura&ccedil;&otilde;es</a>
                  <a href="<?php echo "../secsaude/security/logout.php"; ?>" class="btn btn-outline-danger float-end">Sair</a>
                </li>
                <!--end::Menu Footer-->
              </ul>
            </li>
