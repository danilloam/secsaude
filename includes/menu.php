 <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="/home" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Sistema Distrito</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              <li class="nav-item">
                <a href="./home" class="nav-link <?php if($page==1){echo"active";}?>">
			  ...
			  <li class="nav-item">
                <a href="./visitas" class="nav-link <?php if($page==2){echo"active";}?>">
                  <i class="nav-icon bi bi-journal-medical"></i>
                  <p>Cadastros X Visitas</p>
                </a>
              </li>
			<li class="nav-item">
                <a href="./atendimentos" class="nav-link <?php if($page==3){echo"active";}?>">
			  ...
			  <li class="nav-item <?php if($page==4 || $page==5 ||$page==6){echo "menu-open";}?>">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="./interdicoes" class="nav-link  <?php if($page==4){echo"active";}?>">
                          <i class="nav-icon bi bi-circle"></i>
                          <p>Interdi&ccedil;&otilde;es</p>
                        </a>
                      </li>
					  <li class="nav-item">
                        <a href="./falecomsuaequipe" class="nav-link  <?php if($page==5){echo"active";}?>">
                          <i class="nav-icon bi bi-circle"></i>
                          <p>Fale com sua Equipe</p>
                        </a>
                      </li>
					  <li class="nav-item">
                        <a href="./agendaconecta" class="nav-link  <?php if($page==6){echo"active";}?>">
                          <i class="nav-icon bi bi-circle"></i>
                          <p>Agenda Conecta</p>
                        </a>
                      </li>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="#" class="nav-link" data-bs-toggle="tooltip" data-bs-title="Componente de Equidade">
                      <i class="nav-icon "></i>
                      <p>
                        Equidade
                  ...
                  <li class="nav-item" >
                    <a href="#" class="nav-link" data-bs-toggle="tooltip" data-bs-title="Componente de Vínculo e Acompanhamento Territorial">
                      <i class="nav-icon bi bi-person-check"></i>
                      <p >
                        Vínc. e Acomp. Territorial
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="./dist/docs/javascript/fullscreen.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Fullscreen</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./dist/docs/javascript/accessibility.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Accessibility</p>
                    </a>
                  </li>
